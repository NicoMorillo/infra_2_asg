...
## Auto Scaling Group
 The AWS infrastructure, has its principal focus in deploying 2 instances  by **Auto Scaling Group**, following the **ASG** rules defined. The **ASG** works as a fail-over solution for the instances.
